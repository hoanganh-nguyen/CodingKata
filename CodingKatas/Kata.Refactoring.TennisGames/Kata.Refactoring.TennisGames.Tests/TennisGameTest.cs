...
using Kata.Refactoring.TennisGames.Solution;
using NUnit.Framework;

namespace Kata.Refactoring.TennisGames.Tests
{
    ...
    public class TennisTest
    {
        ...
        {
            TennisGame_v1 game = new TennisGame_v1("player1", "player2");
            checkAllScores(game);
        }
        ...
        {
            TennisGame_v2 game = new TennisGame_v2("player1", "player2");
            checkAllScores(game);
        }
